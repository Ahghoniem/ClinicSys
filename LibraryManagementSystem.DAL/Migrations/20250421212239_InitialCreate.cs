        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Doctors_Department_DepID",
                        column: x => x.DepID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Clinic_schedule_Department_DepID",
                        column: x => x.DepID,
                        principalTable: "Department",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Clinic_schedule_Doctors_DID",
                        column: x => x.DID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    day = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PrescriptionMedicine = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    status = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Patient_schedule", x => x.ID);
                    table.ForeignKey(
                        name: "FK_Patient_schedule_Doctors_DID",
                        column: x => x.DID,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Patient_schedule_Users_PID",
                        column: x => x.PID,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clinic_schedule_DepID",
                table: "Clinic_schedule",
                column: "DepID");

            migrationBuilder.CreateIndex(
                name: "IX_Clinic_schedule_DID",
                table: "Clinic_schedule",
                column: "DID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Patient_schedule_DID",
                table: "Patient_schedule",
                column: "DID");

            migrationBuilder.CreateIndex(
                name: "IX_Patient_schedule_PID",
                table: "Patient_schedule",
                column: "PID");
